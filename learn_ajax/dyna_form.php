            ...
            <div class="col-lg-8 bg-light mt-5 p-4 rounded">
               ...
               <form action="" method="POST">
                ...
                <div class="col-md-14 form-group mt-4">
                        <input type="text" class="form-control" placeholder="Enter Division" id="usr" name="division[]" required> 
                </div>
                <span class="btn btn-success" id="add-btn" >+</span>
                <div id="my-div">
                  <div class="row" id="row-remove">
                    <div class="col-md-10 form-group mt-4">
                        <input type="text" class="form-control" placeholder="Enter District"  id="usr" name="district[]" required> 
                    </div>
